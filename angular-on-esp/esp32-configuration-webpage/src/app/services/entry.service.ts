...
export class EntryService
{
  ...
  getEntries(): Promise<EntryI[]>
  {
    ...
    {
      this.http.get(IP + '/getEntries').subscribe((data) =>
      {
  ...
  testIR(ir: string)
  {
    console.log("Test IR Signal = " + ir); // FOR DEBUG
    this.http.post(IP + '/testIR', { IRRawData: ir }).subscribe((result) => console.log("Test IR send! " + result));
  }
  ...
  addEntry(functionName: string, irRawData: string, enocean?: string)
  {
    ...
    this.http.post(IP + '/addEntry', { functionName: functionName, irRawData: irRawData })
      .subscribe((data: any) =>
      {
        console.log(data);
  ...
  addEnOcean(id: number, enoceanInfo: string)
  {
    ...
    this.http.post(IP + '/addEnocean', { id: id, enocean: enoceanInfo }).subscribe((result) =>
    {
      console.log(result);
    });
  }
  ...
  removeEnocean(entryId: string, enoceanSignal: string): Promise<boolean>
  {
    return new Promise<boolean>((resolve, reject) =>
    {
      ...
      this.http.delete(IP + '/removeEnocean?entryId=' + entryId + '&enocean=' + enoceanSignal).subscribe((res) =>
      {
        console.log(res);
        resolve(true);
      }, (error) => reject(error));
  ...
  {
    this.http.delete(IP + '/removeEntry?entryId=' + entryId).subscribe((result) =>
    {
      console.log(result);
    });
  ...
  {
    console.log("Save");
    this.http.get(IP + '/save').subscribe((response) => console.log(response));
  }
  ...
  restart()
  {
    ...
    this.http.get(IP + '/restart').subscribe((result) => console.log(result));
  }
